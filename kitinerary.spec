...
Version  : 24.12.3
Release  : 145
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kitinerary-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kitinerary-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kitinerary-24.12.3.tar.xz.sig
...
%setup -q -n kitinerary-24.12.3
cd %{_builddir}/kitinerary-24.12.3
pushd ..
cp -a kitinerary-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742527245
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Itinerary.so.6.3.3
/usr/lib64/libKPim6Itinerary.so.6
/usr/lib64/libKPim6Itinerary.so.6.3.3
