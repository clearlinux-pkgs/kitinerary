...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kitinerary-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kitinerary-24.08.0.tar.xz.sig
...
%setup -q -n kitinerary-24.08.0
cd %{_builddir}/kitinerary-24.08.0
pushd ..
cp -a kitinerary-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724661035
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kitinerary-%{version}/readme-build-ftime.txt.license %{buildroot}/usr/share/package-licenses/kitinerary/fca67987925d2ed70e898f6dd9c7fe4b458d416d || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Itinerary.so.6.2.0
/usr/lib64/libKPim6Itinerary.so.6
/usr/lib64/libKPim6Itinerary.so.6.2.0
