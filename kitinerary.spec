...
%setup -q -n kitinerary-24.05.1
cd %{_builddir}/kitinerary-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718595393
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Itinerary.so.6.1.1
/usr/lib64/libKPim6Itinerary.so.6
/usr/lib64/libKPim6Itinerary.so.6.1.1
